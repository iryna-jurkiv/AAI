...
router.post('/addemployee', async (req, res) => {
    ...
    let mailOptions = {
        ...
        html: '<!DOCTYPE html>'+
            ...
            '</head><body><div>'+
            '<p>Dear Candidate </p>'+
            '<p>Welcome to AAI User Access Management System. Please go to http://localhost:3000/employees/employeessignin ' +
            'and use the following email and temporary password to sign in and view your profile </p>'
        ...
        let mailOptionsTwo = {
            from: 'aaiteam20@gmail.com',
                ...
                '</head><body><div>'+
                '<p>Dear Manager </p>'+
                '<p>We are pleased to inform you that you have been assigned a new member of staff. Please visit AAI ' +
                    'portal http://localhost:3000/users/signin to set up their profile. </p>' +
                '<br>' +
                '<p>Kind Regards, </p>'+
                '<p>The AAI Team</p>'+
                '</div></body></html>'
